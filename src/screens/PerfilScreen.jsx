  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.profileHeader}>
       <Image
          //source={require()} // Ajuste o caminho da imagem
      ...
      <View style={styles.settingsButtonContainer}>
        <IconButton
          icon={() => <MaterialCommunityIcons name="cog" size={24} color="#a547bf" />}
          style={styles.settingsButton}
          onPress={() => navigation.navigate('ConfiguraçãoScreen')} // Navega para a tela de configuração
        />
      </View>
      ...
      <View style={styles.buttonsContainer}>
        <Button mode="contained" style={styles.buttonPrimary}>Follow</Button>
        <Button mode="contained" style={styles.buttonSecondary}>Message</Button>
      </View>
      ...
      <Card style={styles.gallerySection}>
        ...
        <Card.Content>
          <View style={styles.gallery}>
            <Image source={{ uri: 'https://via.placeholder.com/100' }} style={styles.galleryImage} />
            <Image source={{ uri: 'https://via.placeholder.com/100' }} style={styles.galleryImage} />
            <Image source={{ uri: 'https://via.placeholder.com/100' }} style={styles.galleryImage} />
          </View>
        </Card.Content>
